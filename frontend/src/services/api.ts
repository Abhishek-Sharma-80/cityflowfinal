...
export const api = {
  ...
  getDeliveries: () => fetchJSON<DeliveryRequestModel[]>('/api/fleet/deliveries', undefined, [
    {
      ...
      destination_coords: [28.495, 77.089],
  ...
  getLoadingZones: () => fetchJSON<LoadingZoneModel[]>('/api/loading-zones', undefined, [
    {
      id: 'LZ-01',
      name: 'Cyber City Freight Dock A',
      zone_id: 'Z-01',
      zone_name: 'Cyber City Hub',
      location: [28.496, 77.091],
      total_bays: 12,
      occupied_bays: 10,
      reserved_bays: 2,
      available_bays: 0,
    ...
    {
      id: 'LZ-02',
      name: 'Connaught Place Radial Dock 4',
      zone_id: 'Z-02',
      zone_name: 'Connaught Place Central',
      location: [28.631, 77.218],
      total_bays: 8,
      occupied_bays: 6,
      reserved_bays: 1,
      available_bays: 1,
    ...
    {
      id: 'LZ-03',
      name: 'Okhla Industrial Freight Staging Hub',
      zone_id: 'Z-05',
      zone_name: 'Okhla Industrial Phase III',
      location: [28.536, 77.274],
      total_bays: 20,
      occupied_bays: 16,
      reserved_bays: 2,
      available_bays: 2,
  ...
  getRecommendations: () => fetchJSON<InfraRecommendationModel[]>('/api/recommendations', undefined, [
    {
      ...
      priority: 'URGENT',
      title: 'Deploy Automated Smart Curb Loading Zone on MG Road',
    ...
    },
    {
      ...
      reasoning: 'Enables 100% zero-emission freight transition for South Delhi deliveries.',
  ...
  optimizeRoute: (origin: string, destination: string, vehicleType: VehicleType = 'ELECTRIC_VAN', cargoWeight: number = 250) =>
    fetchJSON<RouteOptionModel[]>(
      ...
      [
        {
          id: 'route-fastest',
          name: 'NH-48 Express Link',
          mode: 'FASTEST',
          waypoints: [[28.495, 77.089], [28.540, 77.130], [28.590, 77.170], [28.632, 77.219]],
          road_ids: ['R-02'],
          distance_km: 18.2,
          ...
          eco_score: 88,
          toll_cost_inr: 45,
          explainability_text: 'Shortest travel time utilizing high-speed NH-48 corridor.',
          is_recommended: false,
        },
        {
          id: 'route-greenest',
          name: 'Barapullah Green Bypass',
          mode: 'GREENEST',
          waypoints: [[28.495, 77.089], [28.550, 77.200], [28.632, 77.219]],
          road_ids: ['R-07'],
          distance_km: 20.4,
        ...
        },
        {
          ...
          mode: 'CHEAPEST',
          waypoints: [[28.495, 77.089], [28.560, 77.220], [28.632, 77.219]],
          road_ids: ['R-04'],
          distance_km: 19.1,
        ...
        },
        {
          ...
          mode: 'BALANCED',
          waypoints: [[28.495, 77.089], [28.530, 77.160], [28.632, 77.219]],
          road_ids: ['R-01', 'R-07'],
          distance_km: 18.8,
  ...
  runSimulator: (scenario: WhatIfScenarioInput) =>
    fetchJSON<SimulationResultModel>('/api/simulator/run', {
      ...
      recommended_actions: [
        'Preemptively reroute commercial freight via Barapullah corridor.',
  ...
  activateEmergency: (emergencyInput: EmergencyRequestInput) =>
    fetchJSON<EmergencyCorridorResponse>('/api/emergency/activate', {
      ...
      vehicle_callsign: emergencyInput.vehicle_callsign || 'AMB-DELHI-01',
      origin: [emergencyInput.origin_lat || 28.495, emergencyInput.origin_lng || 77.089],
      destination: [emergencyInput.destination_lat || 28.568, emergencyInput.destination_lng || 77.221],
      corridor_waypoints: [[28.495, 77.089], [28.520, 77.120], [28.568, 77.221]],
      cleared_intersections: ['IFFCO Chowk', 'Rajokri Flyover', 'Dhaula Kuan Central', 'AIIMS Ring Junction'],
  ...
  triggerDemo: () =>
    fetchJSON<DemoRunResult>('/api/demo/run', {
      ...
      simulated_inputs: {
        ...
        road_closure: 'MG Road Right 2 Lanes Blocked',
        public_event: 'Cyber Hub Tech Summit Outflow',
      ...
      system_actions_taken: [
        ...
        'CityFlow solver reallocated 132 delivery slots across Okhla and Connaught Place.',
        'Autonomous freight diversion routed 48 commercial vans via Barapullah elevated bypass.',
      ],
  ...
  getSettings: () => fetchJSON<any>('/api/settings', undefined, { profile: 'DELHI_NCR', weights: { road_utilization_weight: 0.35, traffic_density_weight: 0.25 } }),
